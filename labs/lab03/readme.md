...
###  Пример настройки OSPF на ASBR R14:
```
!
router ospf 1
 router-id 1.1.1.14
...
###  2. Настройка ABR R12-R13 в зоне 10, с получением дополнительно маршрута по умолчанию.
...
Totally NSSA - в дополнение к блокированию External LSA (исключение - default), будет блокироваться и Summary LSA. Настраивается на ABR-роутере:
```
!
router ospf 1
 router-id 1.1.1.19
