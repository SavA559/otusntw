...
Для передачи маршрута по умолчанию (статический маршрут до провайдера), заменяющего External LSA необходимо на ABR роутере настроить Not so stubby area (NSSA)
