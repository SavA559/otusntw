...
PBR – форвардинг на основании конфигурации в route map (PBR нужен для управления трафиком по заданной политике)
Задача: Распределение трафика между двумя ISP
